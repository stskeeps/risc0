...
ShuffleMessage Dealer::shuffle(const PlayerCommitMessage& msg) {
  ...
  MethodId methodId = risc0::MethodId::fromElfFile("examples/cpp/deck/shuffle_method");
...
CardResponseMessage Dealer::revealCard(const CardRequestMessage& msg) {
  MethodId methodId = risc0::MethodId::fromElfFile("examples/cpp/deck/card_method");
